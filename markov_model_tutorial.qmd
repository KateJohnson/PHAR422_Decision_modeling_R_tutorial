...
2.  **All transitions to a non-death health state are conditional on survival. The probability of surviving for individuals transitioning from the healthy state (row=H) = `(1-p_HD)`**
